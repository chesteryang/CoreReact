...
namespace CoreReact.Controllers
{
    ...
    [ApiController]
    public class ChinookGenresController : ControllerBase
    {
        private readonly ChinookContext _context;

        public ChinookGenresController(ChinookContext context)
        {
            _context = context;
        }

        // GET: api/ChinookGenres
        [HttpGet]
